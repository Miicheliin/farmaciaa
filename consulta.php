...
<div class="container 75%">
		...
		<div class="col-sm-12">
                    <div class="form-group">
                      <input type="text" name="mostrar" class="form-control" placeholder="Clave" required="required">
                    </div>
                  </div>
				
				  <div class="form-group">
                  <button type="submit" class="btn-submit" name="Aceptar" id="Aceptar"  />Buscar</button>
                </div>
